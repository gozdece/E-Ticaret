	...
	<span> <?php echo number_format($veri["data1"][0]["fiyat"],2,'.',',');
            ...
            <div class="row" id="FormSonuc"></div>
             ...
             <div class="row arkaplan" id="FormAnasi">
				...
				<div class="col-lg-12">
					<input type="text" name="yorum" class="form-control">
				</div>
             	<div class="col-lg-12 text-center">
                	...
                	<input type="button" value="GÖNDER" id="yorumGonder" class="btn hizala_2" />
                </form>
                </div>
...
<img src="'.URL.'/views/design/images/'.$value["res1"].'" alt="'.$value["urunad"].'" /></a>
						...
						<p><a class="item_add" href="'.URL.'/urunler/detay/'.$value["id"].'/'. $ayarlar->seo($value["urunad"]).'"><i></i> <span class="item_price">'. number_format($value["fiyat"],2,'.',',').'</span></a></p>
					</div>';
