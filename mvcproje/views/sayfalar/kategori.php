	...
	<div class="container">
	   <div class="products-page">
			...
			<div class="new-product">
                    ...
                    <div class="col-md-6"><label>Kaç adet</label>
                  <select >
							...
							<a class="cbp-vm-image" href="'.URL.'/urunler/detay/'.$value["id"].'/'.$ayarlar->seo($value["urunad"]).'">
							 ...
							 <div class="view view-first">
								...
								<div class="product_image">
									<img src="'.URL.'/views/design/images/'.$value["res1"].'" class="img-responsive" alt=""/>
									<div class="mask">
			...
			<h3 class="like text-center">ÖNE ÇIKAN ÜRÜNLER</h3>        			
				     <ul id="flexiselDemo3">
						...
						foreach ($veri["data3"] as $value) {
							echo '<li><a href="'.URL.'/urunler/detay/'.$value["id"].'/'.$ayarlar->seo($value["urunad"]).'"><img src="'.URL.'/views/design/images/'.$value["res1"].'" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">'.$value["urunad"].'</a>
