				...
				<div class="products-grid">
                	...
                	<?php
			   		...
			   		?>
						...
						<a href="urunler/detay/<?php  echo $value["id"]; ?>/<?php  echo $ayarlar->seo($value["urunad"]); ?>"><img src="<?php echo URL; ?>/views/design/images/<?php  echo $value["res1"]; ?>" alt="<?php  echo $value["urunad"]; ?>" /></a>
						<div class="mask">
			...
			<h3 class="like text-center">EN ÇOK SATANLAR</h3>        			
				     <ul id="flexiselDemo3">
                          	<?php
			   				...
			   				?>
							<li><a href="urunler/detay/<?php  echo $value2["id"]; ?>/<?php  echo $ayarlar->seo($value2["urunad"]); ?>"><img src="<?php echo URL; ?>/views/design/images/<?php  echo $value2["res2"]; ?>" class="img-responsive" alt="<?php  echo $value2["urunad"]; ?>" /></a>
								<div class="product liked-product simpleCart_shelfItem">
									<a class="like_name" href="urunler/detay/<?php  echo $ayarlar->seo($value2["id"]); ?>/<?php  echo $value2["urunad"]; ?>"><?php  echo $value2["urunad"]; ?></a>
